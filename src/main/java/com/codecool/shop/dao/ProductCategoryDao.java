...
public interface ProductCategoryDao {
     ...
     */
    void add(ProductCategory category) throws ConnectToStorageFailed;
     ...
     */
    ProductCategory find(int id) throws ConnectToStorageFailed;
     ...
     */
    List<ProductCategory> getAll() throws ConnectToStorageFailed;
